(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/app_64c5048c._.js", {
...
function Workspace() {
    ...
    const convertPaper = async (retryAttempt = 0)=>{
        ...
        // 保存到历史记录
        if (file) {
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$utils$2f$localStorageManager$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["saveToHistory"])({
                title: file.name,
                content: finalResult,
...
_s(Workspace, "lZEQmYGtyRNL8WqGC/CJa0iszdA=", false, function() {
    return [
...
//# sourceMappingURL=app_64c5048c._.js.map