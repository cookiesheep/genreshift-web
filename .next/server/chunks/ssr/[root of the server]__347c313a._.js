...
function History() {
    ...
    const loadHistoryData = ()=>{
        ...
        // 短暂延迟以显示加载状态
        setTimeout(()=>{
            const items = (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$utils$2f$localStorageManager$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getHistoryItems"])();
    ...
    const executeDelete = ()=>{
        if (itemToDelete) {
            // 删除单个项目
            if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$utils$2f$localStorageManager$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["deleteHistoryItem"])(itemToDelete)) {
                loadHistoryData(); // 重新加载数据
                setSelectedItems(selectedItems.filter((id)=>id !== itemToDelete));
            }
        } else if (selectedItems.length > 0) {
            // 批量删除
            const deletedCount = (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$utils$2f$localStorageManager$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["deleteHistoryItems"])(selectedItems);
            if (deletedCount > 0) {
                loadHistoryData(); // 重新加载数据
                setSelectedItems([]);
            }
            ...
            // 清空所有
            if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$utils$2f$localStorageManager$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["clearAllHistory"])()) {
                loadHistoryData(); // 重新加载数据
            }
        }
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__347c313a._.js.map