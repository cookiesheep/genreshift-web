...
"[project]/app/api/convert/route.js [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
语言：${parameters.language === 'zh' ? '中文' : '英文'}
    `;
        ...
        // 改进错误处理
        const errorMessage = error.code === 'ECONNABORTED' ? "API请求超时，请稍后再试" : error.message || "转换过程发生错误";
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: errorMessage
        }, {
            status: 500
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__84de9086._.js.map